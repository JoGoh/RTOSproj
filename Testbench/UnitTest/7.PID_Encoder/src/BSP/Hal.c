...
void PortInit( void )
{
	...
	********************************/
	...
	GPIOE->MODER |= (GPIO_MODE_INPUT<<GPIO_MODER_MODER9_Pos);
	...
	GPIOE->MODER |= (GPIO_MODE_INPUT<<GPIO_MODER_MODER11_Pos);
	...
	GPIOB->MODER |= (GPIO_MODE_INPUT<<GPIO_MODER_MODER4_Pos);
	...
	GPIOB->MODER |= (GPIO_MODE_INPUT<<GPIO_MODER_MODER5_Pos);
	...
	GPIOA->MODER |= (GPIO_MODE_INPUT<<GPIO_MODER_MODER0_Pos);
	...
	GPIOA->MODER |= (GPIO_MODE_INPUT<<GPIO_MODER_MODER1_Pos);
	...
	GPIOD->MODER |= (GPIO_MODE_INPUT<<GPIO_MODER_MODER12_Pos);
	...
	GPIOD->MODER |= (GPIO_MODE_INPUT<<GPIO_MODER_MODER13_Pos);
