...
#define PE_M1_ENC_IN1		9U
#define PE_M1_ENC_IN2		11U
#define PB_M2_ENC_IN1		4U
#define PB_M2_ENC_IN2		5U
#define PA_M3_ENC_IN1		0U
#define PA_M3_ENC_IN2		1U
#define PD_M4_ENC_IN1		12U
#define PD_M4_ENC_IN2		13U
...
#define IN_M1_ENC_IN1()				((GPIOE->IDR & BIT(PE_M1_ENC_IN1))? TRUE : FALSE)
#define IN_M1_ENC_IN2()				((GPIOE->IDR & BIT(PE_M1_ENC_IN2))? TRUE : FALSE)

#define IN_M2_ENC_IN1()				((GPIOB->IDR & BIT(PB_M2_ENC_IN1))? TRUE : FALSE)
#define IN_M2_ENC_IN2()				((GPIOB->IDR & BIT(PB_M2_ENC_IN2))? TRUE : FALSE)

#define IN_M3_ENC_IN1()				((GPIOA->IDR & BIT(PA_M3_ENC_IN1))? TRUE : FALSE)
#define IN_M3_ENC_IN2()				((GPIOA->IDR & BIT(PA_M3_ENC_IN2))? TRUE : FALSE)

#define IN_M4_ENC_IN1()				((GPIOD->IDR & BIT(PD_M4_ENC_IN1))? TRUE : FALSE)
#define IN_M4_ENC_IN2()				((GPIOD->IDR & BIT(PD_M4_ENC_IN2))? TRUE : FALSE)
