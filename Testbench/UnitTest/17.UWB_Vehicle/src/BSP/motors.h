...
//
//#define PID_CONST_KP				0.1
//#define PID_CONST_KI				0.045 //integral gain for garnering speed slowly
//#define PID_CONST_KD				0.0099  //jerking motion on vehicle if set too high/if overshoot tune this

//#define PID_CONST_KP				1
//#define PID_CONST_KI				0.4
//#define PID_CONST_KD				0.0

#define PID_CONST_KP				0.5// Changed
