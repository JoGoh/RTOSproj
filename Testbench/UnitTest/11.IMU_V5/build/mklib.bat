...
copy ".\Output\IMUV5 with algo Release\Obj" .\Output\Release\Obj

ar.exe -r -c -s ..\Lib\IMU_LIB.a     .\Output\Release\Obj\imu.o .\Output\Release\Obj\PololuV5.o
...
ar.exe -r -c -s ..\Lib\DMA_LIB.a    .\Output\Release\Obj\dma.o
pause
